...
7. Rewrite Professional Summary injecting JD keywords + career narrative bridge ("Built storage infrastructure at Amazon S3 scale. Now applying distributed systems expertise to [JD domain].")
...
- JD says "distributed systems" and CV says "services at scale" → change to "distributed systems architecture at 75,000+ host scale"
- JD says "microservices" and CV says "backend services" → change to "microservices architecture with Spring Boot"
...
- Rewrite Professional Summary with JD keywords + career narrative
